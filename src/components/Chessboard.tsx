...
export const Chessboard = ({
  ...
  socket: WebSocket;
  setBoard: (board: typeof board) => void; // Properly typed setter function
  chess: any; // Type should match your chess instance (e.g., `Chess` from chess.js)
}) => {
  // State for selected squares
  const [from, setFrom] = useState<null | Square>(null);
  const [_to, setTo] = useState<null | Square>(null);
